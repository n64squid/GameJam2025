...
#define ROBOT_BONE_TABLE(X) \
	...
	X(ROBOT_BONE_JAW,          ROBOT_BONE_TORSO,        ROBOT_SPRITE_JAW,   16.0f,  0.0f) \
	X(ROBOT_BONE_HEAD,         ROBOT_BONE_JAW,          ROBOT_SPRITE_HEAD,  0.0f,  -6.0f) \
	X(ROBOT_BONE_ARM_UPPER_L,  ROBOT_BONE_TORSO,        ROBOT_SPRITE_LIMB,   -8.0f,  0.0f) \
	X(ROBOT_BONE_ARM_LOWER_L,  ROBOT_BONE_ARM_UPPER_L,  ROBOT_SPRITE_ARM,   0.0f,   19.0f) \
	X(ROBOT_BONE_ARM_UPPER_R,  ROBOT_BONE_TORSO,        ROBOT_SPRITE_LIMB,   8.0f,   0.0f) \
	X(ROBOT_BONE_ARM_LOWER_R,  ROBOT_BONE_ARM_UPPER_R,  ROBOT_SPRITE_ARM,   0.0f,   19.0f) \
	X(ROBOT_BONE_LEG_UPPER_L,  ROBOT_BONE_TORSO,        ROBOT_SPRITE_LIMB,   -8.0f,  32.0) \
	X(ROBOT_BONE_LEG_LOWER_L,  ROBOT_BONE_LEG_UPPER_L,  ROBOT_SPRITE_LEG,   0.0f,   19.0f) \
	X(ROBOT_BONE_LEG_UPPER_R,  ROBOT_BONE_TORSO,        ROBOT_SPRITE_LIMB,   8.0f,   32.0) \
